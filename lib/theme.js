...
const theme = {
  ...
  buttons: {
    ...
    outlineRoundedDanger: {
      variant: "buttons.primary",
      bg: "red",
      color: "dark400",
      border: "2px solid currentColor",
    },
    outlineRoundedDangerLg: {
      variant: "buttons.outlineRoundedDanger",
      height: "50px",
    },
    rounded: {
      variant: "buttons.primary",
  ...
  forms: {
    input: {
      ...
      borderRadius: "base",
      border: 0,
      "::-webkit-input-placeholder": { color: "dark400" },
      "::-moz-placeholder": { color: "dark400" },
      ":-ms-input-placeholder": { color: "dark400" },
